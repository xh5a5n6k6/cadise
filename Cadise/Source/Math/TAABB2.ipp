...
template<typename T>
inline void TAABB2<T>::setMinVertex(const TVector2<T>& minVertex)
{
    _minVertex = minVertex;
}

template<typename T>
inline void TAABB2<T>::setMaxVertex(const TVector2<T>& maxVertex)
{
    _maxVertex = maxVertex;
}

template<typename T>
inline void TAABB2<T>::setMinMaxVertices(
...
template<typename T>
inline void TAABB2<T>::set(const TAABB2<T>& other)
{
