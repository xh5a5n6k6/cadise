...
inline Vector3 TransformPoint(Matrix4 mat, Vector3 v) {
    return Vector3(mat.n(0, 0) * v.x() + mat.n(0, 1) * v.y() + mat.n(0, 2) * v.z() + mat.n(0, 3),
                   mat.n(1, 0) * v.x() + mat.n(1, 1) * v.y() + mat.n(1, 2) * v.z() + mat.n(1, 3),
                   mat.n(2, 0) * v.x() + mat.n(2, 1) * v.y() + mat.n(2, 2) * v.z() + mat.n(2, 3));
}

inline Vector3 TransformVector(Matrix4 mat, Vector3 v) {
    return Vector3(mat.n(0, 0) * v.x() + mat.n(0, 1) * v.y() + mat.n(0, 2) * v.z(),
                   mat.n(1, 0) * v.x() + mat.n(1, 1) * v.y() + mat.n(1, 2) * v.z(),
                   mat.n(2, 0) * v.x() + mat.n(2, 1) * v.y() + mat.n(2, 2) * v.z());
}
